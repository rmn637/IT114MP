        ...
        protected void EvaluateBtn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //using (NpgsqlConnection connection = new NpgsqlConnection(@"Server=localhost;Port=5432;User Id=postgres;Password=123456;Database=EmplyeeEval;"))
                {
                    ...
                    Response.Write($"<script>alert(' {formID} {OfficersFormID}')</script>");

                    sqlCode = @"INSERT INTO ""OfficerForm"" (""OfficerFormID"", ""FormID"", ""Section1IOWR"", ""Section2CNWR"", ""Section3CWR"", ""Section4CWR"", ""Strength"", ""Improvement"", ""Development"", ""Acknowledgement"", ""OverallWR"") VALUES (@OfficerFormID, @FormID, 0, 0, 0, 0, 0, 0, 0, 0, 0)";
                    command = new NpgsqlCommand(sqlCode, connection);
