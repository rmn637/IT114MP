...
<body>
    <form id="form1" runat="server">
        ...
        <div id="main">
            ...
            <center>
            <h2>Performance Evaluation Survey</h2>
                <table>
                    <tr id="trbc">
            ...
            <br />
            <center>
            <p> Question1<asp:RequiredFieldValidator ID="rfvQ1" runat="server" ErrorMessage="*" ControlToValidate="question1"></asp:RequiredFieldValidator> </p>
            <p> Weight: </p>
            ...
            <div id ="section1A">
                <table class="auto-style2">
                    ...
                    <tr>
                        ...
                        <td class="auto-style8">W</td>
                        <td class="auto-style9">R</td>
                        <td class="auto-style10">WS</td>
                    </tr>
                    <tr>
                        <td class="auto-style6">A.&nbsp; Faculty Evaluation by Students</td>
                        <td class="auto-style5">70</td>
