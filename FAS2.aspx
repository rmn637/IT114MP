<%@ Page Title="Agreement Section 2 Faculty" Language="C#" MasterPageFile="~/Child.Master" AutoEventWireup="true" CodeBehind="FAS2.aspx.cs" Inherits="WebApplication1.AgreementSection2Faculty" %>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="navbar">
        ...
        <asp:LinkButton ID="LinkButton2" runat="server" Enabled="false" style="color:black; background-color:#808080">Section 2</asp:LinkButton> &nbsp; &nbsp; &nbsp;
