<%@ Page Title="Officer Evaluation Section 4" Language="C#" MasterPageFile="~/Child.Master" AutoEventWireup="true" CodeBehind="OES4.aspx.cs" Inherits="WebApplication1.EvaluationSection4Officers" %>
...
<asp:LinkButton ID="btnSection4" runat="server"  Enabled="false">Section 4</asp:LinkButton> &nbsp; &nbsp; &nbsp;
    ...
    <table class="auto-style2">
        ...
        <tr>
            ...
            <td class="auto-style9">
                <asp:Label ID="weight1_1" runat="server"></asp:Label>
            </td>
        ...
        <tr>
            ...
            <td class="auto-style9">
                <asp:Label ID="weight1_2" runat="server"></asp:Label>
            </td>
            <td class="auto-style4">
        ...
        <tr>
            ...
            <td class="auto-style9">
                <asp:Label ID="weight1_3" runat="server"></asp:Label>
            </td>
            <td class="auto-style4">
        ...
        <tr>
            ...
            <td class="auto-style9">
                <asp:Label ID="weight1_4" runat="server"></asp:Label>
            </td>
            <td class="auto-style4">
        ...
        <tr>
            ...
            <td class="auto-style9">
                <asp:Label ID="weight1_5" runat="server"></asp:Label>
            </td>
            <td class="auto-style4">
