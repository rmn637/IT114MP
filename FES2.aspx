<%@ Page Title="Faculty Evaluation Section 2" Language="C#" MasterPageFile="~/Child.Master" AutoEventWireup="true" CodeBehind="FES2.aspx.cs" Inherits="WebApplication1.EvaluationSection2Faculty" %>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="navbar">
        ...
        <asp:LinkButton ID="btnSection2" runat="server" Enabled="false" style="color:black; background-color:#808080">Section 2</asp:LinkButton> &nbsp; &nbsp; &nbsp;
    ...
    <table class="auto-style2">
        ...
        <tr>
            ...
            <td class="auto-style9">
                    <asp:Label ID="weight2_1" runat="server" Text="0"></asp:Label>
                </td>
        ...
        <tr>
            ...
            <td class="auto-style9">
                    <asp:Label ID="weight2_2" runat="server" Text="0"></asp:Label>
                </td>
            <td class="auto-style4">
        ...
        <tr>
            ...
            <td class="auto-style9">
                    <asp:Label ID="weight2_3" runat="server" Text="0"></asp:Label>
                </td>
            <td class="auto-style4">
        ...
        <tr>
            ...
            <td class="auto-style9">
                    <asp:Label ID="weight2_4" runat="server" Text="0"></asp:Label>
                </td>
            <td class="auto-style4">
        ...
        <tr>
            ...
            <td class="auto-style9">
                    <asp:Label ID="weight2_5" runat="server" Text="0"></asp:Label>
                </td>
            <td class="auto-style4">
