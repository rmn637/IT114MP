<%@ Page Title="Agreement Section 3 Officer" Language="C#" MasterPageFile="~/Child.Master" AutoEventWireup="true" CodeBehind="OAS3.aspx.cs" Inherits="WebApplication1.AgreementSection3Officers" %>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <center>
        ...
        <div class="navbar" id="navibar">
            ...
            <asp:LinkButton ID="btnSection3" runat="server" Enabled="false" style="color:black; background-color:#eaeaea">Section 3</asp:LinkButton> &nbsp; &nbsp; &nbsp;
        ...
        <table class="auto-style2">
            ...
            <tr>
                <td class="auto-style9">
                    <asp:TextBox ID="weight1_1" runat="server" AutoPostBack="True" Height="18px" TabIndex="1" Width="91px" CssClass="normal" OnTextChanged="weight_TextChanged">0</asp:TextBox>
                </td>
            ...
            <tr>
                <td class="auto-style9" id="weight1_2">
                    <asp:TextBox ID="weight1_2" runat="server" AutoPostBack="True" Height="18px" TabIndex="2" Width="91px" CssClass="normal" OnTextChanged="weight_TextChanged">0</asp:TextBox>
                </td>
                <td class="auto-style4">
                    &nbsp;</td>
                <td>
            ...
            <tr>
                <td class="auto-style9">
                    <asp:TextBox ID="weight1_3" runat="server" AutoPostBack="True" Height="18px" TabIndex="3" Width="91px" CssClass="normal" OnTextChanged="weight_TextChanged">0</asp:TextBox>
                </td>
                <td class="auto-style4">
                    &nbsp;</td>
                <td>
            ...
            <tr>
                <td class="auto-style9">
                    <asp:TextBox ID="weight1_4" runat="server" AutoPostBack="True" Height="18px" TabIndex="4" Width="91px" CssClass="normal" OnTextChanged="weight_TextChanged">0</asp:TextBox>
                </td>
                <td class="auto-style4">
                    &nbsp;</td>
                <td>
            ...
            <tr>
                <td class="auto-style9">
                    <asp:TextBox ID="weight1_5" runat="server" AutoPostBack="True" Height="18px" TabIndex="5" Width="91px" CssClass="normal" OnTextChanged="weight_TextChanged">0</asp:TextBox>
                </td>
                <td class="auto-style4">
                    &nbsp;</td>
                <td>
            ...
            <tr>
                <td class="auto-style9">
                    <asp:TextBox ID="weight1_6" runat="server" AutoPostBack="True" Height="18px" TabIndex="6" Width="91px" CssClass="normal" OnTextChanged="weight_TextChanged">0</asp:TextBox>
                </td>
                <td class="auto-style4">
                    &nbsp;</td>
                <td>
            ...
            <tr>
                <td class="auto-style9">
                    <asp:TextBox ID="weight1_7" runat="server" AutoPostBack="True" Height="18px" TabIndex="7" Width="91px" CssClass="normal" OnTextChanged="weight_TextChanged">0</asp:TextBox>
                </td>
                <td class="auto-style4">
                    &nbsp;</td>
                <td>
            ...
            <tr>
                <td class="auto-style9">
                    <asp:TextBox ID="weight1_8" runat="server" AutoPostBack="True" Height="18px" TabIndex="8" Width="91px" CssClass="normal" OnTextChanged="weight_TextChanged">0</asp:TextBox>
                </td>
                <td class="auto-style4">
                    &nbsp;</td>
                <td>
            ...
            <tr>
                <td class="auto-style14">3</td>
                <td class="auto-style8" colspan="4">&nbsp;Behaves broadly in line general organizational values.</td>
            </tr>
            <tr>
                <td class="auto-style7">4</td>
