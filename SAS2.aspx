<%@ Page Title="Agreement Section 2 Staff" Language="C#" MasterPageFile="~/Child.Master" AutoEventWireup="true" CodeBehind="SAS2.aspx.cs" Inherits="WebApplication1.AgreementSection2Staff" %>
    ...
    <table class="auto-style2">
        ...
        <tr>
            ...
            <td class="auto-style9">
                <asp:TextBox ID="weight2_1" runat="server" Height="18px" TabIndex="1" Width="91px" OnTextChanged="weight_TextChanged" AutoPostBack="true" CssClass="normal">0</asp:TextBox>
            </td>
