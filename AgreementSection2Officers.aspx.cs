...
namespace WebApplication1
{
    public partial class AgreementSection2Officers : System.Web.UI.Page
    {
        ...
        protected string CompileAnswers()
        {
            ...
            text += $"1|{scope1.Text}|-|{weight2_1.Text}|0;";
            text += $"2|{scope2.Text}|-|{weight2_2.Text}|0;";
            text += $"3|{scope3.Text}|-|{weight2_3.Text}|0;";
            text += $"4|{scope4.Text}|-|{weight2_4.Text}|0";
