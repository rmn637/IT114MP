<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="EvaluationOverallOfficers.aspx.cs" Inherits="WebApplication1.EvaluationOverallOfficers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <center>
        <div class="navbar" id="navibar">
            ...
            <asp:LinkButton ID="btnSection5" runat="server" OnClick="checkWeight">Section 4</asp:LinkButton> &nbsp; &nbsp; &nbsp;
        ...
        <center>
            <table width ="25%">
                ...
                <tr>
                    ...
                    <td class="auto-style9">
                    <asp:Label ID="lblTotalWeight3" runat="server"></asp:Label>
                    </td>
                    <td class="auto-style9">
                ...
                <tr>
                    ...
                    <td class="auto-style9">
                    <asp:Label ID="lblTotalWeight4" runat="server"></asp:Label>
                    </td>
                    <td class="auto-style9">
                    <asp:TextBox ID="total4" runat="server" AutoPostBack="True" Height="18px" TextMode="Number" Width="91px" Enabled="False">0</asp:TextBox>
                    </td>
                </tr>
                <tr>
