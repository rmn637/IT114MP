<%@ Page Title="Evaluation Comment Faculty" Language="C#" MasterPageFile="~/Child.Master" AutoEventWireup="true" CodeBehind="OEC.aspx.cs" Inherits="WebApplication1.EvaluationCommentsOfficers" %>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <center>
        <div class="navbar" id="navibar">
            ...
            <asp:LinkButton ID="btnSection5" runat="server" Enabled="false">Section 5</asp:LinkButton> &nbsp; &nbsp; &nbsp;
