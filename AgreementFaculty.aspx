        ...
        <table class="auto-style2">
            ...
            <tr>
                ...
                <td class="auto-style18">
                    <asp:TextBox ID="weight1_A" runat="server" AutoPostBack="True" Height="18px" OnTextChanged="weight_TextChanged1_A" TextMode="Number" Width="91px">0</asp:TextBox>
                </td>
            ...
            <tr>
                ...
                <td class="auto-style18">
                    <asp:TextBox ID="weight1_B" runat="server" AutoPostBack="True" Height="18px" OnTextChanged="weight_TextChanged1_A" TextMode="Number" Width="91px">0</asp:TextBox>
                </td>
                <td class="auto-style4">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;</td>
            ...
            <tr>
                ...
                <td class="auto-style18">
                    <asp:TextBox ID="weight1_C" runat="server" AutoPostBack="True" Height="18px" OnTextChanged="weight_TextChanged1_A" TextMode="Number" Width="91px">0</asp:TextBox>
                </td>
                <td class="auto-style4">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;</td>
                <td>
        ...
        <table class="auto-style2">
            ...
            <tr>
                ...
                <td class="auto-style5">
                    <asp:TextBox ID="weight1_1" runat="server" AutoPostBack="True" Height="18px" OnTextChanged="weight_TextChanged1_B" TextMode="Number" Width="91px">0</asp:TextBox>
                </td>
                <td class="auto-style4">
                    &nbsp;</td>
                <td>
            ...
            <tr>
                ...
                <td class="auto-style5">
                    <asp:TextBox ID="weight1_2" runat="server" AutoPostBack="True" Height="18px" OnTextChanged="weight_TextChanged1_B" TextMode="Number" Width="91px">0</asp:TextBox>
                </td>
                <td class="auto-style4">
                    &nbsp;</td>
                <td>
            ...
            <tr>
                ...
                <td class="auto-style5">
                    <asp:TextBox ID="weight1_3" runat="server" AutoPostBack="True" Height="18px" OnTextChanged="weight_TextChanged1_B" TextMode="Number" Width="91px">0</asp:TextBox>
                </td>
                <td class="auto-style4">
                    &nbsp;</td>
                <td>
            ...
            <tr>
                ...
                <td class="auto-style5">
                    <asp:TextBox ID="weight1_4" runat="server" AutoPostBack="True" Height="18px" OnTextChanged="weight_TextChanged1_B" TextMode="Number" Width="91px">0</asp:TextBox>
                </td>
                <td class="auto-style4">
                    &nbsp;</td>
                <td>
            ...
            <tr>
                ...
                <td class="auto-style5">
                    <asp:TextBox ID="weight1_5" runat="server" AutoPostBack="True" Height="18px" OnTextChanged="weight_TextChanged1_B" TextMode="Number" Width="91px">0</asp:TextBox>
                </td>
                <td class="auto-style4">
                    &nbsp;</td>
                <td>
...
<div id ="section2">
    <table class="auto-style2">
        ...
        <tr>
            ...
            <td class="auto-style9" id="weight2_1">
                <asp:TextBox ID="weight2_1" runat="server" AutoPostBack="True" Height="18px" OnTextChanged="weight_TextChanged2" TextMode="Number" Width="91px">0</asp:TextBox>
            </td>
            <td class="auto-style4">
                &nbsp;</td>
            <td>
        ...
        <tr>
            ...
            <td class="auto-style9">
                <asp:TextBox ID="weight2_2" runat="server" AutoPostBack="True" Height="18px" OnTextChanged="weight_TextChanged2" TextMode="Number" Width="91px">0</asp:TextBox>
            </td>
            <td class="auto-style4">
                &nbsp;</td>
            <td>
        ...
        <tr>
            ...
            <td class="auto-style9" id="weight2_3">
                <asp:TextBox ID="weight2_3" runat="server" AutoPostBack="True" Height="18px" OnTextChanged="weight_TextChanged2" TextMode="Number" Width="91px">0</asp:TextBox>
            </td>
            <td class="auto-style4">
                &nbsp;</td>
            <td>
        ...
        <tr>
            ...
            <td class="auto-style9">
                <asp:TextBox ID="weight2_4" runat="server" AutoPostBack="True" Height="18px" OnTextChanged="weight_TextChanged2" TextMode="Number" Width="91px">0</asp:TextBox>
            </td>
            <td class="auto-style4">
                &nbsp;</td>
            <td>
        ...
        <tr>
            ...
            <td class="auto-style9">
                <asp:TextBox ID="weight2_5" runat="server" AutoPostBack="True" Height="18px" OnTextChanged="weight_TextChanged2" TextMode="Number" Width="91px">0</asp:TextBox>
            </td>
            <td class="auto-style4">
                &nbsp;</td>
            <td>
