<%@ Page Title="Officer Evaluation Section 3" Language="C#" MasterPageFile="~/Child.Master" AutoEventWireup="true" CodeBehind="OES3.aspx.cs" Inherits="WebApplication1.EvaluationSection3Officers" %>
        ...
        <table class="auto-style2">
            ...
            <tr>
                ...
                <td class="auto-style4">
                    <asp:TextBox ID="rating1_1" runat="server" AutoPostBack="True" Height="18px" Width="91px" OnTextChanged="rating2_TextChanged">0</asp:TextBox>
                </td>
                <td>
